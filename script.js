...
function handleMouseDown(key) {
    playNotes(key.getAttribute("data-note"))
...
/* COLOCA AS FUNÇÕES EM CADA TECLA */
keys.forEach((key) => {
...
checkbox.addEventListener('change', ({ target }) => {
    ...
    if (target.checked) {
        ...
        keysSelection.classList.remove('disabled-keys')
        return;
    }
    keysSelection.classList.add('disabled-keys');
